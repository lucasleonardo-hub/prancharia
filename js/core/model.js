...
export const MOTIVOS_PENDENCIA = {
  ...
  vinculo_por_chamada: 'Local indicado pela linha de chamada',
  categoria_obrigatoria: 'Categoria obrigatória do ambiente, sem fonte nos documentos',
  rejunte_obrigatorio: 'Revestimento cerâmico sem rejunte especificado',
  item_obrigatorio: 'Item esperado neste tipo de ambiente, sem fonte nos documentos',
...
export const ACOES_PENDENCIA = {
  ...
  item_obrigatorio: { fazer: 'Todo ambiente deste tipo tem este item (bacia e cuba no banho, pia e bancada na cozinha, tanque na área de serviço, porta e rodapé nos cômodos), mas nenhum documento o especificou. Procure no memorial, no quadro de louças e metais ou no de esquadrias e preencha em Editar; se este ambiente realmente não tem, exclua a linha.', botoes: ['editar', 'excluir'] },
